...
--
-- Host: 127.0.0.1
-- Generation Time: May 07, 2024 at 12:33 PM
...
CREATE TABLE `profile_page` (
  `favorite_class` varchar(255) DEFAULT NULL,
  `dating` varchar(255) DEFAULT NULL,
  `teachers` varchar(255) DEFAULT NULL,
  `year_level` varchar(255) DEFAULT NULL,
  `homeroom_class` varchar(255) DEFAULT NULL,
  `groups` varchar(255) DEFAULT NULL,
  `best_friend` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(13, 'peteij@chairo.vic.edu.au', '$2y$10$AZyrxOUutpPUvPc5s9UmYuS41rAnlcQF.Bcq8.RZ045w9hmNcNfHm', 'Sir Isaac Newton');
